...
above x y = 
    ...
    -- NOTE: i had it backwards, at first, debug.log helped me see that I was comparing the wrong way
    y > x
...
log base target =
    ...
    -- "... such that 3^n is less than or equal to 100." <- The part of chat gpt's explanation that gave it away
